...
export default function BuyerCertificationsPage() {
  const { user } = useAuth();
  ...
  const certifications = {
    ...
    pending: [
      ...
      { name: 'Import License', issuer: 'Commerce Department', estimatedDate: '2024-11-30' },
    ],
    expired: [
        ...
        <div className="flex-1 overflow-auto p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-on-surface-variant">
              Manage your business certifications and buyer credentials
            </p>
          </div>
