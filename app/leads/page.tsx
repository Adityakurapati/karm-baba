              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-surface-container border-b border-outline-variant">
                    <th className="px-6 py-4 text-left font-headline font-bold text-on-surface">
                      Company
                    </th>
                    <th className="px-6 py-4 text-left font-headline font-bold text-on-surface">
                      Contact
                ...
                <tbody>
                  {filteredLeads.map((lead) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <button className="px-4 py-2 bg-primary text-white font-bold text-sm rounded hover:bg-primary-dark transition-colors">
                          Contact
                        </button>
                      </td>
                    </tr>
